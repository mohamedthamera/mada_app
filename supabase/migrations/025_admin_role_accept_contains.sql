-- قبول أي role يحتوي على كلمة admin (حل مشكلة "مطلوب صلاحيات الأدمن" مع role=admin في الجدول)
-- ورسالة خطأ توضح user_id والقيمة الفعلية لـ role لمساعدتك في التتبع
